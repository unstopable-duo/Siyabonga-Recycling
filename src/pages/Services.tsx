...
export function Services() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] text-[#1A1A1A] font-sans pb-24">
      ...
      {/* Services List */}
      <div className="max-w-7xl mx-auto border-b border-[#1A1A1A]/10">
        {services.map((service, index) => (
          <motion.div 
            ...
            key={service.id} 
            className="grid grid-cols-1 lg:grid-cols-12 group border-t border-[#1A1A1A]/10 first:border-none"
          >
            
            {/* Number & Title */}
            <div className="lg:col-span-5 p-8 md:p-16 border-b lg:border-b-0 lg:border-r border-[#1A1A1A]/10 flex flex-col justify-between bg-white group-hover:bg-[#FAFAF9] transition-colors duration-500">
              <div>
              ...
              <div className="hidden lg:flex w-12 h-12 border border-[#1A1A1A]/20 items-center justify-center rounded-full mt-auto group-hover:bg-[#05812A] group-hover:border-[#05812A] group-hover:text-white transition-all duration-300">
      ...
      <div className="max-w-7xl mx-auto border-b border-[#1A1A1A]/10 grid grid-cols-1 lg:grid-cols-2">
        <div className="p-8 md:p-16 border-b lg:border-b-0 lg:border-r border-[#1A1A1A]/10 bg-white hover:bg-[#FAFAF9] transition-colors duration-500">
          ...
          <div className="space-y-6">
            <div className="group">
              <h4 className="text-[10px] uppercase tracking-[0.2em] font-black border-b border-[#1A1A1A]/10 pb-2 mb-3 group-hover:border-[#05812A] transition-colors">High-Value Non-Ferrous Metals</h4>
              <p className="text-xs text-[#4A4A4A] leading-relaxed">
                <span className="font-bold text-[#1A1A1A]">Copper (Bright Wire, Tubing):</span> The most rewarding metal to recycle. Highest payouts.<br/>
                <span className="font-bold text-[#1A1A1A]">Brass (Taps, Fittings):</span> Excellent value, heavily sought after.<br/>
                <span className="font-bold text-[#1A1A1A]">Aluminum (Cans, Castings):</span> Consistently good cash returns per kilogram.
              </p>
            </div>
            <div className="group">
              <h4 className="text-[10px] uppercase tracking-[0.2em] font-black border-b border-[#1A1A1A]/10 pb-2 mb-3 group-hover:border-[#05812A] transition-colors">Ferrous Metals & Iron</h4>
              <p className="text-xs text-[#4A4A4A] leading-relaxed">
                <span className="font-bold text-[#1A1A1A]">Steel & Iron:</span> Tin cans, old appliances, and heavy melting steel. Needs volume for high payouts, but always accepted.
              </p>
            </div>
            <div className="group">
              <h4 className="text-[10px] uppercase tracking-[0.2em] font-black border-b border-[#1A1A1A]/10 pb-2 mb-3 group-hover:border-[#05812A] transition-colors">Basic Recyclables & E-Waste</h4>
              <p className="text-xs text-[#4A4A4A] leading-relaxed">
                <span className="font-bold text-[#1A1A1A]">Plastics (PET, HDPE):</span> Milk jugs and bottles.<br/>
                <span className="font-bold text-[#1A1A1A]">Cardboard & Paper:</span> Excellent way to keep streets clean.<br/>
                <span className="font-bold text-[#1A1A1A]">Glass & E-Waste:</span> Intact bottles and circuit boards from phones yield immediate cash.
              </p>
            </div>
          </div>
        </div>
        <div className="p-8 md:p-16 bg-[#FAFAF9] hover:bg-white transition-colors duration-500">
          ...
          <div className="space-y-8">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="flex gap-4 p-4 border border-transparent hover:border-[#1A1A1A]/10 hover:shadow-sm transition-all rounded-sm bg-white"
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#4A4A4A] leading-relaxed">Collect your scrap metals, plastics, or boards and transport them to our Germiston or Boksburg yard. *Note: Under the Second-Hand Goods Act, bringing an ID may be required for large metal drop-offs to prevent theft.</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#4A4A4A] leading-relaxed">Our staff will help you offload. We use calibrated industrial scales to ensure accurate weights for every category of scrap you provide.</p>
              </div>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, x: 20 }}
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#4A4A4A] leading-relaxed">We calculate your payout based on the day's top rates and hand you cash directly. Simple, clean, and honest business.</p>
              </div>
            </motion.div>
          </div>
        </div>
